...
USAGE_EOF
            ...
            is_reserved_hermes_env_name() {
              case "$1" in
                OCSB_HERMES_AGENT_PERSIST_DIR|OCSB_HERMES_AGENT_API_KEYS_ENV_FILE|HERMES_HOME|HERMES_MANAGED|MESSAGING_CWD)
                  return 0
                  ;;
                *)
                  return 1
            ...
            is_default_hermes_api_key_env_name() {
              case "$1" in
                OPENROUTER_API_KEY|OPENAI_API_KEY|ANTHROPIC_API_KEY|HF_TOKEN|HUGGINGFACE_API_KEY|HUGGINGFACEHUB_API_TOKEN|GOOGLE_API_KEY|GEMINI_API_KEY|GOOGLE_GENERATIVE_AI_API_KEY|GROQ_API_KEY|MISTRAL_API_KEY|COHERE_API_KEY|TOGETHER_API_KEY|DEEPSEEK_API_KEY|XAI_API_KEY|PERPLEXITY_API_KEY|FIREWORKS_API_KEY|AZURE_OPENAI_API_KEY|VOYAGE_API_KEY)
                  return 0
                  ;;
                *)
                  return 1
