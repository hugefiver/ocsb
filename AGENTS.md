...
- Wrapper-reserved env names (`OCSB_HERMES_AGENT_PERSIST_DIR`, `OCSB_HERMES_AGENT_API_KEYS_ENV_FILE`, `HERMES_HOME`, `MESSAGING_CWD`) must be rejected for `--env ...` with error text mentioning “reserved for the Hermes Agent wrapper”.
