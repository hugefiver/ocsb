...
pkgs.writeShellScriptBin "ocsb-hermes" ''
  ...
  is_default_hermes_api_key_env_name() {
    case "$1" in
      OPENROUTER_API_KEY|OPENAI_API_KEY|ANTHROPIC_API_KEY|HF_TOKEN|HUGGINGFACE_API_KEY|HUGGINGFACEHUB_API_TOKEN|GOOGLE_API_KEY|GEMINI_API_KEY|GOOGLE_GENERATIVE_AI_API_KEY|GROQ_API_KEY|MISTRAL_API_KEY|COHERE_API_KEY|TOGETHER_API_KEY|DEEPSEEK_API_KEY|XAI_API_KEY|PERPLEXITY_API_KEY|FIREWORKS_API_KEY|AZURE_OPENAI_API_KEY|VOYAGE_API_KEY|BWS_ACCESS_TOKEN|ANTHROPIC_TOKEN|CLAUDE_CODE_OAUTH_TOKEN|NOVITA_API_KEY|GLM_API_KEY|ZAI_API_KEY|Z_AI_API_KEY|KIMI_API_KEY|KIMI_CN_API_KEY|KIMI_CODING_API_KEY|STEPFUN_API_KEY|ARCEEAI_API_KEY|GMI_API_KEY|MINIMAX_API_KEY|MINIMAX_CN_API_KEY|DASHSCOPE_API_KEY|ALIBABA_CODING_PLAN_API_KEY|NVIDIA_API_KEY|AI_GATEWAY_API_KEY|OPENCODE_ZEN_API_KEY|OPENCODE_GO_API_KEY|KILOCODE_API_KEY|XIAOMI_API_KEY|TOKENHUB_API_KEY|OLLAMA_API_KEY|AZURE_FOUNDRY_API_KEY|LM_API_KEY|COPILOT_GITHUB_TOKEN|GH_TOKEN|GITHUB_TOKEN|NOUS_API_KEY|QWEN_API_KEY|DEEPINFRA_API_KEY|UPSTAGE_API_KEY|ACTUAL_API_KEY|TOKENPLAN_API_KEY)
        return 0
        ;;
      *)
        return 1
